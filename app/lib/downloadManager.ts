 ...
 * Creates folder structure: Downloads/Keuangan/YYYY-MM-DD/
 */
export function downloadTransactionsAsJSON(
  ...
  try {
    ...
    link.href = url;
    // Note: Browser can't create nested folders automatically
    // We use folder name as part of filename
...
/**
 * Save transactions to localStorage and download as JSON
 */
